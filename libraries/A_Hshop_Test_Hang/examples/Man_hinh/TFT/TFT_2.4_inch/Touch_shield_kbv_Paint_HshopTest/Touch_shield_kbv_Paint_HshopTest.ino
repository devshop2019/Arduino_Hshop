...
//        Serial.println("\t\ttp.y" + String(tp.y));
...
//        TS_LEFT = 920; TS_RT = 139; TS_TOP = 944; TS_BOT = 150;
        TS_RT = 902; TS_LEFT = 83; TS_BOT = 890; TS_TOP = 70;     //kxn 
        SwapXY = 0;
        ...
        name = "ILI9341 4747";
        TS_RT = 854; TS_LEFT = 198; TS_BOT = 903; TS_TOP = 142;     //kxn 
        SwapXY = 0;
    } else {
        name = "unknown";
        TS_RT = 902; TS_LEFT = 83; TS_BOT = 890; TS_TOP = 70;
        SwapXY = 0;
    }
...
//    Serial.println("tp.z: " + String(tp.z));
//    Serial.println("MINPRESSURE: " + String(MINPRESSURE));
//    Serial.println("MAXPRESSURE: " + String(MAXPRESSURE));
//    Serial.println("11-------------");
...
//        Serial.println("tp.x: " + String(tp.x));
//        Serial.println("tp.y: " + String(tp.y));
//        Serial.println("11-------------");
...
//        Serial.println("currentcolor: " + String(currentcolor));
