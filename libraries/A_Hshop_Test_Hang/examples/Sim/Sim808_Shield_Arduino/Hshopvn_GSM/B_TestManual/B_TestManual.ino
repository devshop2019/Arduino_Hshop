...
P/S: 
     - nap code
     - cap nguon tren board Sim va cam day nap vô arduino
     - nhan giu nut tren mach Sim den khi mach Sim sáng đèn là được
     1/ Choosing "Both NL & CR" and "9600" baudrate!
