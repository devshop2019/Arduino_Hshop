...
{
  Serial.begin(9600);
  Serial.println("Start Hshop test DAC MCP4725");
  Serial.println("Input number from 0 to 511, if number greater than 511, you need reset MCU");
  Wire.begin();
