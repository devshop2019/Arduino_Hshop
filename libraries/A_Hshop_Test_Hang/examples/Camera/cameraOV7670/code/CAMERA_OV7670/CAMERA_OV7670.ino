...
//LINK:https://circuitdigest.com/microcontroller-projects/how-to-use-ov7670-camera-module-with-arduino
...
3V3         -      3V3
GND         -      GND
SCL         -      SCL(KÉO TRỞ 10K-3V3)
SDA         -      SDA(KÉO TRỞ 10K->3V3)
VS(VSYNC)   -      D3
HS(HREF)    -      D8
PLK(PCLK)   -      D2
XLK(XCLK)   -      D11(NỐI THÔNG QUA CẦU PHÂN ÁP D11->4K7->XLK,4K7->GND)
D0          -      A0
D1          -      A1
D2          -      A2
D3          -      A3
